...
#define TC_IOT_CONFIG_MQTT_HOST "/*${template_config.Domain}*/"

/* 产品id，可以在产品“基本信息”->“产品id”位置找到*/
#define TC_IOT_CONFIG_PRODUCT_ID "/*${template_config.ProductId}*/"

/* 产品id，可以在产品“基本信息”->“产品key”位置找到*/
#define TC_IOT_CONFIG_PRODUCT_KEY "/*${template_config.ProductKey}*/"
