...
typedef enum _tc_iot_sys_code_e {
    ...
    TC_IOT_FUNCTION_NOT_IMPLEMENTED = -99,     /**< 适配函数未做迁移实现 */
    ...
    TC_IOT_NKV_OVERFLOW = -320, /**< NKV 缓存不足, 无法保存更多数据*/
...
typedef enum _tc_iot_event_e {
    ...
    /* TC_IOT_MQTT_EVENT_ERROR_NOTIFY, */

    TC_IOT_MQTT_EVENT_CONNECT_SUCCESS ,
    TC_IOT_MQTT_EVENT_CONNECT_FAILED,
    TC_IOT_MQTT_EVENT_PUB_SUCCESS ,
    TC_IOT_MQTT_EVENT_PUB_FAILED,
    TC_IOT_MQTT_EVENT_SUB_SUCCESS ,
    TC_IOT_MQTT_EVENT_SUB_FAILED,
    TC_IOT_MQTT_EVENT_UNSUB_SUCCESS ,
    TC_IOT_MQTT_EVENT_UNSUB_FAILED,
    TC_IOT_MQTT_EVENT_RECONNECT_SUCCESS,
    TC_IOT_MQTT_EVENT_RECONNECT_FAILED,

    TC_IOT_MQTT_EVENT_SERVER_PUB_RECEIVED,
    TC_IOT_MQTT_EVENT_SERVER_PUB_TOO_BIG,

    TC_IOT_MQTT_EVENT_DISCONNECTED,
    TC_IOT_SHADOW_EVENT_BASE = 100,
    TC_IOT_SHADOW_EVENT_BEFORE_SERVER_CONTROL,
    TC_IOT_SHADOW_EVENT_SERVER_CONTROL,
    TC_IOT_SHADOW_EVENT_AFTER_SERVER_CONTROL,
    TC_IOT_SHADOW_EVENT_REMOTE_CONF,
